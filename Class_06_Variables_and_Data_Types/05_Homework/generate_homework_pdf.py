...
Generates Class_06_Homework.pdf directly from Class_06_Homework.md.
...
Re-run whenever Class_06_Homework.md changes.
"""
...
# ============================================================================
# Palette - matches the Class 06 Presentation's design system, so the
...
def main():
    ...
    md_path = os.path.join(here, "Class_06_Homework.md")
    out_path = os.path.join(here, "Class_06_Homework.pdf")
    ...
    doc = SimpleDocTemplate(
        ...
        title="Class 06 Homework — Variables & Data Types",
        author="Bong Study Hub",
        subject="Foundation Batch 2026 — Class 06 Homework",
    )
    count = len(flowables)
    doc.build(flowables)
