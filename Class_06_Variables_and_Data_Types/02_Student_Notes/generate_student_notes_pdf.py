...
Generates Class_06_Student_Notes.pdf directly from Class_06_Student_Notes.md.
...
parsing strategy as Class 05's
...
Re-run whenever Class_06_Student_Notes.md changes.
"""
...
# ============================================================================
# Palette - matches the Class 05 Presentation and Homework, so the whole
...
def main():
    ...
    md_path = os.path.join(here, "Class_06_Student_Notes.md")
    out_path = os.path.join(here, "Class_06_Student_Notes.pdf")
    ...
    doc = SimpleDocTemplate(
        ...
        title="Class 06 Student Notes — Variables & Data Types",
        author="Bong Study Hub",
        subject="Foundation Batch 2026 — Class 06 Student Notes",
    )
    count = len(flowables)
    doc.build(flowables)
