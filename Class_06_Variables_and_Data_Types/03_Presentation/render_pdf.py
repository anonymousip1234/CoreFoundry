...
Renders Class_06_Variables_and_Data_Types.pptx to a PDF by
...
re-verified for Classes 03-05: PowerPoint COM instantiates but
...
approach to Class 05's `03_Presentation/render_pdf.py`.
...
def main():
    ...
    out_pdf = os.path.join(here, "Class_06_Variables_and_Data_Types.pdf")
