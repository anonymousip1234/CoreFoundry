...
Generates Class_03_Homework.pdf directly from Class_03_Homework.md.
...
Re-run whenever Class_03_Homework.md changes.
"""
...
# ============================================================================
# Palette - matches the Class 03 Presentation's design system, so the
...
def main():
    ...
    md_path = os.path.join(here, "Class_03_Homework.md")
    out_path = os.path.join(here, "Class_03_Homework.pdf")
    ...
    doc = SimpleDocTemplate(
        ...
        title="Class 03 Homework — Understanding Data",
        author="Bong Study Hub",
        subject="Foundation Batch 2026 — Class 03 Homework",
    )
    count = len(flowables)
    doc.build(flowables)
