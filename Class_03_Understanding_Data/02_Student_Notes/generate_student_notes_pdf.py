...
Generates Class_03_Student_Notes.pdf directly from Class_03_Student_Notes.md.
...
parsing strategy as the Class 03 Homework's
`05_Homework/generate_homework_pdf.py`, so the whole class's PDFs read
as one visual identity.

Usage:
    python generate_student_notes_pdf.py

Re-run whenever Class_03_Student_Notes.md changes.
"""
...
def main():
    ...
    md_path = os.path.join(here, "Class_03_Student_Notes.md")
    out_path = os.path.join(here, "Class_03_Student_Notes.pdf")
    ...
    doc = SimpleDocTemplate(
        ...
        title="Class 03 Student Notes — Understanding Data",
        author="Bong Study Hub",
        subject="Foundation Batch 2026 — Class 03 Student Notes",
    )
    count = len(flowables)
    doc.build(flowables)
