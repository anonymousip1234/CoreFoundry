...
Renders Class_04_How_Computers_Represent_Information.pptx to a PDF by
...
re-verified for Classes 03 and 04: PowerPoint COM instantiates but
...
approach to Class 03's `03_Presentation/render_pdf.py`.
...
def main():
    ...
    out_pdf = os.path.join(here, "Class_04_How_Computers_Represent_Information.pdf")
