...
Generates Class_07_Homework.pdf directly from Class_07_Homework.md.
...
Re-run whenever Class_07_Homework.md changes.
"""
...
# ============================================================================
# Palette - matches the Class 07 Presentation's design system, so the
...
def main():
    ...
    md_path = os.path.join(here, "Class_07_Homework.md")
    out_path = os.path.join(here, "Class_07_Homework.pdf")
    ...
    doc = SimpleDocTemplate(
        ...
        title="Class 07 Homework — Operators & Expressions",
        author="Bong Study Hub",
        subject="Foundation Batch 2026 — Class 07 Homework",
    )
    count = len(flowables)
    doc.build(flowables)
