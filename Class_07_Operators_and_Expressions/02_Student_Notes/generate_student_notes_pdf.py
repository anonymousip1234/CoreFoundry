...
Generates Class_07_Student_Notes.pdf directly from Class_07_Student_Notes.md.
...
parsing strategy as Class 06's
...
Re-run whenever Class_07_Student_Notes.md changes.
"""
...
# ============================================================================
# Palette - matches the Class 06 Presentation and Homework, so the whole
...
def main():
    ...
    md_path = os.path.join(here, "Class_07_Student_Notes.md")
    out_path = os.path.join(here, "Class_07_Student_Notes.pdf")
    ...
    doc = SimpleDocTemplate(
        ...
        title="Class 07 Student Notes — Operators & Expressions",
        author="Bong Study Hub",
        subject="Foundation Batch 2026 — Class 07 Student Notes",
    )
    count = len(flowables)
    doc.build(flowables)
