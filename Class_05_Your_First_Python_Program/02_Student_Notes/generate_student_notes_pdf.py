...
Generates Class_05_Student_Notes.pdf directly from Class_05_Student_Notes.md.
...
parsing strategy as Class 04's
...
Re-run whenever Class_05_Student_Notes.md changes.
"""
...
# ============================================================================
# Palette - matches the Class 04 Presentation and Homework, so the whole
...
def main():
    ...
    md_path = os.path.join(here, "Class_05_Student_Notes.md")
    out_path = os.path.join(here, "Class_05_Student_Notes.pdf")
    ...
    doc = SimpleDocTemplate(
        ...
        title="Class 05 Student Notes — Your First Python Program",
        author="Bong Study Hub",
        subject="Foundation Batch 2026 — Class 05 Student Notes",
    )
    count = len(flowables)
    doc.build(flowables)
