...
Renders Class_05_Your_First_Python_Program.pptx to a PDF by
...
re-verified for Classes 03, 04, and 05: PowerPoint COM instantiates but
...
approach to Class 04's `03_Presentation/render_pdf.py`.
...
def main():
    ...
    out_pdf = os.path.join(here, "Class_05_Your_First_Python_Program.pdf")
