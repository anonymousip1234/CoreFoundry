...
Generates Class_05_Homework.pdf directly from Class_05_Homework.md.
...
Re-run whenever Class_05_Homework.md changes.
"""
...
# ============================================================================
# Palette - matches the Class 05 Presentation's design system, so the
...
def main():
    ...
    md_path = os.path.join(here, "Class_05_Homework.md")
    out_path = os.path.join(here, "Class_05_Homework.pdf")
    ...
    doc = SimpleDocTemplate(
        ...
        title="Class 05 Homework — Your First Python Program",
        author="Bong Study Hub",
        subject="Foundation Batch 2026 — Class 05 Homework",
    )
    count = len(flowables)
    doc.build(flowables)
