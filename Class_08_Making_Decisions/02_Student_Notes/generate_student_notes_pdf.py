...
Generates Class_08_Student_Notes.pdf directly from Class_08_Student_Notes.md.
...
parsing strategy as Class 07's
...
Re-run whenever Class_08_Student_Notes.md changes.
"""
...
# ============================================================================
# Palette - matches the Class 07 Presentation and Homework, so the whole
...
def main():
    ...
    md_path = os.path.join(here, "Class_08_Student_Notes.md")
    out_path = os.path.join(here, "Class_08_Student_Notes.pdf")
    ...
    doc = SimpleDocTemplate(
        ...
        title="Class 08 Student Notes — Making Decisions: if / elif / else",
        author="Bong Study Hub",
        subject="Foundation Batch 2026 — Class 08 Student Notes",
    )
    count = len(flowables)
    doc.build(flowables)
