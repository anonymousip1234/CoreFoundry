...
Renders Class_08_Making_Decisions.pptx to a PDF by
...
re-verified for Classes 03-07: PowerPoint COM instantiates but
...
approach to Class 07's `03_Presentation/render_pdf.py`.
...
def main():
    ...
    out_pdf = os.path.join(here, "Class_08_Making_Decisions.pdf")
