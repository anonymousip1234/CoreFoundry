...
Generates Class_08_Homework.pdf directly from Class_08_Homework.md.
...
Re-run whenever Class_08_Homework.md changes.
"""
...
# ============================================================================
# Palette - matches the Class 08 Presentation's design system, so the
...
def main():
    ...
    md_path = os.path.join(here, "Class_08_Homework.md")
    out_path = os.path.join(here, "Class_08_Homework.pdf")
    ...
    doc = SimpleDocTemplate(
        ...
        title="Class 08 Homework — Making Decisions: if / elif / else",
        author="Bong Study Hub",
        subject="Foundation Batch 2026 — Class 08 Homework",
    )
    count = len(flowables)
    doc.build(flowables)
